...
def message():    
    if(Symptom1.get() == "None" or Symptom2.get() == "None"):
        messagebox.showinfo("OPPS!!", "Kindly Fill atleast First two Symptoms")
...
#Label for the name
NameLb = Label(root, text="Name of the Patient", fg="blue", bg="pink")
...
S3Lb.grid(row=11, column=1, pady=10, sticky=W)

S4Lb = Label(root,  text="Symptom 4", fg="Black", bg="Ivory")
S4Lb.config(font=("Elephant", 15))
S4Lb.grid(row=12, column=1, pady=10, sticky=W)

S5Lb = Label(root,  text="Symptom 5", fg="Black", bg="Ivory")
S5Lb.config(font=("Elephant", 15))
S5Lb.grid(row=13, column=1, pady=10, sticky=W)

lr = Button(root, text="Predict",height=1, width=15, command=message,bg="Light green",fg="red")
lr.config(font=("Times",15,"bold italic"))
lr.grid(row=15, column=1,pady=10)

rs = Button(root,text="Reset Inputs", command=Reset,bg="Light blue",fg="purple",width=15)
rs.config(font=("Times",15,"bold italic"))
rs.grid(row=16,column=1,pady=10)

ex = Button(root,text="Exit System", command=Exit,bg="yellow",fg="purple",width=15)
ex.config(font=("Times",15,"bold italic"))
ex.grid(row=17,column=1,pady=20)

OPTIONS = sorted(l1)

S1En = OptionMenu(root, Symptom1,*OPTIONS)
S1En.grid(row=9, column=3)

S2En = OptionMenu(root, Symptom2,*OPTIONS)
S2En.grid(row=10, column=3)

S3En = OptionMenu(root, Symptom3,*OPTIONS)
S3En.grid(row=11, column=3)

S4En = OptionMenu(root, Symptom4,*OPTIONS)
S4En.grid(row=12, column=3)

S5En = OptionMenu(root, Symptom5,*OPTIONS)
S5En.grid(row=13, column=3)
